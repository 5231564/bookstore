...
public interface BookMapper extends MyMapper<Book> {
    ...
    int insertBook(@Param("bookNumber")Integer bookNumber,@Param("bookName")String bookName,@Param("author")String author,@Param("press")String press,@Param("cover")String cover,@Param("price")Double price,@Param("type")String type,@Param("content")String content);
